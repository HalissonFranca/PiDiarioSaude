...
public class PrescricaoMedicaDTO {
    ...
    public PrescricaoMedicaDTO(PrescricaoMedicaEntity entity) {
        ...
        this.id_medico = entity.getMedico().getId();
        this.nomeMedico = entity.getMedico().getName();
    ...
    public void setId_prescricao(long id) {
    ...
    public void setData_prescricao(String data) {
        this.data_prescricao = data;
    }
    ...
    public List<PrescricaoMedicamentoDTO> getMedicamentos() {
        return medicamentos;
    }

    public void setMedicamentos(List<PrescricaoMedicamentoDTO> medicamentos) {
        this.medicamentos = medicamentos;
    }

    public List<ExercicioRecomendadoDTO> getExerciciosRecomendados() {
        return exerciciosRecomendados;
    }

    public void setExerciciosRecomendados(List<ExercicioRecomendadoDTO> exerciciosRecomendados) {
        this.exerciciosRecomendados = exerciciosRecomendados;
    }

    public List<PrescricaoExameDTO> getExames() {
        return exames;
    }

    public void setExames(List<PrescricaoExameDTO> exames) {
        this.exames = exames;
    }
}